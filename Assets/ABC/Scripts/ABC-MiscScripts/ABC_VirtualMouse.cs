...
namespace ABCToolkit    {
    public class ABC_VirtualMouse : MonoBehaviour
    {
        ...
        [SerializeField]*/ private CursorMode m_CursorMode = CursorMode.SoftwareCursor;
        ...
        /// <summary>
        /// Will get the virtual mouse position
        /// </summary>
        /// <returns>Vector2 of the virtual cursor</returns>
        public Vector2 GetVirtualMousePosition() {

            return this.m_CursorTransform.anchoredPosition;
        ...
        public void ResetMousePosition() {
            ...
            Vector2 CenterScreen = new Vector2(Screen.width / 2, Screen.height / 1.7f);
            // Update hardware cursor.
            m_SystemMouse?.WarpCursorPosition(CenterScreen);
            InputState.Change(m_VirtualMouse.position, CenterScreen);
            m_CursorTransform.anchoredPosition = CenterScreen;
        ...
        protected void Update() {
            ...
            if (Cursor.visible == false) {
                this.cursorGraphic.enabled = false;
            } else if (this.cursorGraphic.enabled == false){

                this.ResetMousePosition();
                this.cursorGraphic.enabled = true;
